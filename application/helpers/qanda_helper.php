...
// reecurity Checked: POST, GET, SESSION, REQUEST, returnGlobal, DB
...
function do_shortfreetext($ia)
{
    ...
    elseif((int)($aQuestionAttributes['location_mapservice'])==1)
    {
        ...
        if (!(Yii::app()->getClientScript()->isScriptFileRegistered(Yii::app()->getConfig('generalscripts')."map9.js")))
    ...
    elseif((int)($aQuestionAttributes['location_mapservice'])==100)
    {
        ...
        if (!(Yii::app()->getClientScript()->isScriptFileRegistered(Yii::app()->getConfig('generalscripts')."map9.js")))
          Yii::app()->getClientScript()->registerScriptFile(Yii::app()->getConfig('generalscripts')."map.js");
        if (!(Yii::app()->getClientScript()->isCssFileRegistered(Yii::app()->getConfig('publicstyleurl') . 'map9.css')))
...
function do_geopoint($ia)
{
    ...
    elseif((int)($aQuestionAttributes['location_mapservice'])==100)
    {
        ...
        $answer = doRender('/survey/questions/geopoint/location_mapservice/item_100', $itemDatas, true);
    }
    else
    {
        //no question attribute set, use common input text field
